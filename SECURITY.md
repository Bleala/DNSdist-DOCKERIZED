...
Please note, this policy applies to the **Docker packaging, configuration, and build process** of DNSdist. Vulnerabilities found in the DNSdist software itself should be reported directly to the upstream project, [PowerDNS/pdns](https://github.com/PowerDNS/pdns).
...
**[➡️ Report a Security Vulnerability Here](https://github.com/Bleala/DNSdist-DOCKERIZED/security/advisories/new)**
...
The public key and verification instructions are available in the project's [**README.md**](https://github.com/Bleala/DNSdist-DOCKERIZED#image-signing--verification).
